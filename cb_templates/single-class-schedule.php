...
/*echo "<pre>";
print_r(get_df_data($fcd['coursedate']));
echo "</pre>";
exit;*/
?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <p><?php echo format_course_date(get_df_data($fcd['coursedate']), get_df_data($fcd['coursetime']), get_df_data($fcd['courseendtime'])); ?></p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <?php if( !empty( $course_addon ) ) { $i = 0; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <br />
                                    <button type="button" name="validate_promo_code" id="validate_promo_code" >Validate Promo Code</button>
...
jQuery(document).ready(function(){
	var num    = parseFloat(jQuery("#actual_cost").val());
	jQuery("#total_cost").html(num.toFixed( 2 ));
});
