<?php /*?><div class="full_width col-md-12 centered">
...
<div>
	<div id="accordion">
		...
		if (CB\Posttypes::havePosts()) {
			...
			foreach ($courses as $course) {
		?>
				<h3 class="panel-heading"><?php echo $course['classes'][0]['agency'] . ' ' . $course['classes'][0]['course']; ?></h3>
					<div>
						<?php 
						if ($course['category']['cat_comment']) {

							echo '<h4 style="font-family:OpenSansSemiBold"><strong>Course Description</strong></h4>';

							echo '<h5 style="font-size:13px">'. $course['category']['cat_comment'] . '</h5>';
