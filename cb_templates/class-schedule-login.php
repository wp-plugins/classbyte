...
<div id="cb_login_form">
    ...
    <div class="form-group-cb">
        ...
        <input type="email" id="cb_login_email" name="cb_login_email" value="" class="form-control-cb">
    ...
    <div class="form-group-cb">
        ...
        <input type="password" id="cb_login_password" name="cb_login_password"  value="" autocomplete="off" class="form-control-cb">
    ...
    <input type="submit" class="pull-right btn-cb" value="Login">
