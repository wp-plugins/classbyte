    ...
    <form class="reg-page" id="cb_forms-only-ajax" method="post" name="cb_reg_form">
        ...
        <div id="cb_reg_form">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text" value="" id="studentsname" name="studentsname">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text" value="" name="studentlastname" id="studentlastname">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text" value="" name="studentaddress" id="studentaddress">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text" value="" name="studentaddress2" id="studentaddress2">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text" value="" id="studentcity" name="studentcity">
            ...
            <label for="studentstate">State <em>(e.g. TX)</em></label>
                ...
                <select id="studentstate" class="form-control-cb" name="studentstate">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text" value="" id="studentzip" name="studentzip">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb"   data-mask="999-999-9999" type="text" value="" id="studentphone" name="studentphone">
            ...
            <div class="form-group-cb">
                ...
                <input class="form-control-cb" type="text"  data-mask="999-999-9999"  value="" name="studentmobilephone" id="studentmobilephone">
            ...
            <div class="form-group-cb">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control-cb" type="email" value="" id="studentemddress" name="studentemddress">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <input class="form-control-cb" type="password" value="" id="studentpassword" name="studentpassword">
                ...
                <div class="col-lg-6">
                    ...
                    <input class="form-control-cb" type="password" value="" id="studentpassword2" name="studentpassword2">
